...
Load this only when `guide.md` points here. The repository evaluator is shared
...
`execution/platforms/slurm/guide.md` owns the standard template, persistent results mount,
