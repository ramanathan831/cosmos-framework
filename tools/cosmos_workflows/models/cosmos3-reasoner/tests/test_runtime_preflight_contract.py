...
def test_rl_repeated_media_auto_profile_emits_measured_validation_cache_contract() -> None:
    args = _video_args()
    args.run_mode = "full"
...
def test_cosmos_rl_preflight_rejects_dependency_abi_and_dispatch_regressions() -> None:
    ...
    assert "shared Omni preparation entrypoint and pinned native Framework converter" in contract["checks"]
