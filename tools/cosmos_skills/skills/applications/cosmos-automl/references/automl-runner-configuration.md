...
- Setup
- or (when reinstalling cosmos-automl with the wandb extra):
- `pip install "$(${COSMOS_SKILLS_ROOT:?}/scripts/resolve_versions_key.py wheels.tao_automl_brev | sed 's/]/,wandb]/')"`
- How it works
- Minimal WandB setup
