...
(skills/core/cosmos-artifacts/references/best_rec.schema.json), which the DEFT
...
SCHEMA_PATH = Path(__file__).resolve().parents[3] / "core/cosmos-artifacts/references/best_rec.schema.json"
...
def build_best_rec(
    *,
    ...
    checkpoint_uri: str,
    all_recs=None,
    budget_keys=DEFAULT_BUDGET_KEYS,
