...
CLI:
    ...
    python scripts/align_token_usage.py \
        ...
        --project-dir ~/.claude/projects/-home-user-cosmos-framework
    ...
    python scripts/align_token_usage.py \
        --state-path /abs/path/results/deft_state.json \
        --cwd ~/cosmos-framework/tools/cosmos_skills
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        f"align_token_usage: {len(new_entries)} stages, {total_msgs}/{len(messages)} assistant messages attributed",
        file=sys.stderr,
    )
